    ...
    namespace detail {
        ...
        struct compute_mix_vector {
            ...
            call(vec<L, T, Q> const &x, vec<L, T, Q> const &y, vec<L, U, Q> const &a) {
                ...
                return vec<L, T, Q>(
                        vec<L, U, Q>(x) * (static_cast<U>(1) - a) + vec<L, U, Q>(y) * a);
            }
        };
...
#	endif
        ...
        struct compute_min_vector {
            GLM_FUNC_QUALIFIER static vec<L, T, Q>
            call(vec<L, T, Q> const &x, vec<L, T, Q> const &y) {
        ...
        struct compute_step_vector {
            GLM_FUNC_QUALIFIER static vec<L, T, Q>
            call(vec<L, T, Q> const &edge, vec<L, T, Q> const &x) {
...
#		endif
    ...
    GLM_FUNC_QUALIFIER genType smoothstep(genType edge0, genType edge1, genType x) {
        GLM_STATIC_ASSERT(
                std::numeric_limits<genType>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
                "'smoothstep' only accept floating-point inputs");
